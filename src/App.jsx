  ...
  return (
    <div className="min-h-screen flex flex-col">
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="hidden lg:flex items-center gap-6 border-l border-gray-100 pl-8 h-10">
                <div className="flex items-center gap-2 text-gray-600 hover:text-medical transition-colors cursor-pointer">
                  ...
                  <span className="text-sm font-semibold">+91 95537 22793</span>
                </div>
                <div className="flex items-center gap-2 text-gray-600 hover:text-medical transition-colors cursor-pointer">
                  <div className="p-2 bg-medical/5 rounded-full">
                    <svg className="w-4 h-4 text-medical" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm font-semibold">care@cityhospital.in</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm space-y-2">
              <span className="block">📞 +91 95537 22793</span>
              <span className="block">✉️ care@cityhospital.in</span>
              <span className="block">📍 Apollo Hospital Rd, Jubilee Hills, Hyderabad</span>
            </p>
          </div>
        </div>
      ...
      <a
        ...
        className="fixed bottom-[76px] right-[16px] z-[1000] flex items-center gap-3 group"
        aria-label="Chat with us on WhatsApp"
      >
        <div className="bg-white text-gray-800 text-[0.85rem] font-medium py-2 px-4 rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.15)] relative border border-gray-100 transition-all duration-300 transform group-hover:-translate-y-1">
          WhatsApp Us! 😊
        ...
        <div className="relative">
          <div className="w-[60px] h-[60px] flex justify-center items-center rounded-full bg-[#25D366] shadow-[0_4px_12px_rgba(0,0,0,0.15)] text-white transition-all duration-300 group-hover:scale-110">
          ...
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              document.getElementById('whatsapp-floating').style.display = 'none';
            }}
            className="absolute -top-[6px] -right-[6px] w-[22px] h-[22px] bg-white text-[#64748b] rounded-full flex items-center justify-center shadow-[0_2px_5px_rgba(0,0,0,0.1)] border border-[#e2e8f0] z-[1002] hover:text-red-500 hover:border-red-200 transition-all hover:scale-110"
