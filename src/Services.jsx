...
export default function Services({ setPage }) {
    const serviceDetails = [
        ...
        {
            title: "Cardiology",
            desc: "Advanced heart care and prevention programs.",
            benefits: ["ECG & EKG", "Heart rate monitoring", "Cardiac rehabilitation"]
        },
        {
            title: "Pediatrics",
            desc: "Compassionate healthcare for infants and adolescents.",
            benefits: ["Growth monitoring", "Immunizations", "Nutrition counseling"]
        },
        {
            title: "Dermatology",
            desc: "Treatments for skin, hair, and nail conditions.",
            benefits: ["Acne treatment", "Skin cancer screening", "Cosmetic procedures"]
        },
        {
            title: "Dental Care",
            desc: "Complete oral health services and treatments.",
            benefits: ["Routine cleaning", "Cavity fillings", "Orthodontics"]
        }
    ];
